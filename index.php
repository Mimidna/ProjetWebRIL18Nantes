		...
		<div class="col-md-12">
			<div class="carousel slide" id="carousel-7837">
				<ol class="carousel-indicators">
					...
					<li data-slide-to="2" data-target="#carousel-7837" class="active">
					</li>
				</ol>
				<div class="carousel-inner">
					<div class="carousel-item">
						<img class="d-block w-100" alt="Carousel Bootstrap First" src="images/mini/mini.jpg" />
					...
					<div class="carousel-item">
						<img class="d-block w-100" alt="Carousel Bootstrap Second" src="images/sportive/sportive.jpg" />
						<div class="carousel-caption">
							<h4>
					...
					<div class="carousel-item active">
						<img class="d-block w-100" alt="Carousel Bootstrap Third" src="images/SUV/suv1.jpg" />
						<div class="carousel-caption">
							<h4>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="media">
						<img class="mr-10" alt="Bootstrap Media Preview" src="https://www.layoutit.com/img/sports-q-c-64-64-8.jpg" />
